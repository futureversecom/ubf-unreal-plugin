...
namespace UBF
{
	...
	class FMakeMaterialBase : public FCustomNode
	{
	public:
	...
	protected:
		...
		void AddRenderMode(TMap<FString, FShaderPropertyValue>& PropertyMap, const FString& ResourceName,const FString& PropertyName) const;
	};
}
